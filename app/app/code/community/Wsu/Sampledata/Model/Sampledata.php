<?php
class Wsu_Sampledata_Model_Launcher extends Mage_Core_Model_Abstract {
    const CONFIG_CACHE_ID = 'wsu_sampledata_config';
    protected $_config;
    ...
    protected function _initConfig( ) {
        ...
        if ( false !== $data ) {
            ...
            $xml  = Mage::getConfig()->loadModulesConfiguration( 'sampledata.xml' )->getNode();
            $data = $xml->asArray();
